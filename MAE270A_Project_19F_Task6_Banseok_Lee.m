...
% PH2norm=trace(B07'*Goinf*B07);
% PH2norm=sqrt(PH2norm);
% 
% %% Task 5-3
% 
% hk=[];
...
% sum
% y=HinfnormofPd(A07, B07, C07,[0 0;0 0],0,1000,0.01);
% D=zeros(2,2);
% sys07=ss(A07,B07,C07,D,ts);
% ninf = hinfnorm(sys07)
% [n,fpeak] = norm(sys07,Inf)
% k=HinfnormofPd(A07,B07,C07,D,0,0,0);
% 
% w=(log((1+j*fpeak)/(1-j*fpeak)))/(j*ts)
% 
% k
