...
%%% Graph of A06
% 
% figure('Name','Impulse response of A06');
% 
% subplot(521);
% plot(t,u1,'b*','LineWidth',2);
% ylabel('$u_1$ (volts)','FontSize',14,'Interpreter','Latex');
...
% axis([-0.2 2 -0.1 0.1])
% title('Response data of $y_2$ (volts) for A06','Interpreter','Latex')
% sgtitle('Impulse response of A06');
% 
...
% figure('Name','Impulse response of A10');
% 
% subplot(521);
% plot(t,u1,'b*','LineWidth',2);
% ylabel('$u_1$ (volts)','FontSize',14,'Interpreter','Latex');
...
% 
% title('Response data of $y_2$ (volts) for A10','Interpreter','Latex')
% sgtitle('Impulse response of A10');
...
% figure('Name','Impulse response of A20');
% 
% subplot(521);
% plot(t,u1,'b*','LineWidth',2);
% ylabel('$u_1$ (volts)','FontSize',14,'Interpreter','Latex');
...
% 
% title('Response data of $y_2$ (volts) for A20','Interpreter','Latex')
% sgtitle('Impulse response of A20');
...
subplot(4,4,1);
plot(t,abs(y11-Y0611),'r*','LineWidth',2);
ylabel('$y_1$ (volts)','FontSize',14,'Interpreter','Latex');
set(gca,'FontSize',14)
grid on
axis([-0.2 1 -0.1 0.1])
